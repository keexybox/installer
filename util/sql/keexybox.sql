...
CREATE TABLE `profiles_ipfilters` (
  ...
  `dest_ip` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dest_ip_mask` int(2) NOT NULL,
  `dest_iprange_first` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dest_iprange_last` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dest_hostname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2020-01-22 14:42:24
