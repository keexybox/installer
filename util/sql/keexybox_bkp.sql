...
CREATE TABLE `devices` (
  ...
  `mac` varchar(17) NOT NULL,
  `dhcp_reservation_ip` varchar(15) NOT NULL,
...
CREATE TABLE `profiles` (
  ...
  `default_routing` varchar(50) NOT NULL DEFAULT 'bypass',
  `default_ipfilter` varchar(6) NOT NULL,
  `log_enabled` tinyint(1) NOT NULL,
  `use_ttdnsd` tinyint(1) NOT NULL,
  `safesearch_google` tinyint(1) NOT NULL,
  `safesearch_bing` tinyint(1) NOT NULL,
  `safesearch_youtube` tinyint(1) NOT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `profiles_ipfilters` (
  ...
  `profile_id` int(20) NOT NULL,
  `dest_ip_type` varchar(8) NOT NULL,
  `dest_ip` varchar(15) NOT NULL,
  `dest_ip_mask` int(2) NOT NULL,
  `dest_iprange_first` varchar(15) NOT NULL,
  `dest_iprange_last` varchar(15) NOT NULL,
  `dest_hostname` varchar(255) NOT NULL,
  `protocol` varchar(4) NOT NULL,
  `dest_ports` varchar(100) NOT NULL,
...
-- Dump completed on 2019-12-23 12:16:08
